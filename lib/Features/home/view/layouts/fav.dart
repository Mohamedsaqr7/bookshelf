              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return bookcard(
                      onPressed1: () {
                        cubit.removeFav(
                            id: cubit.favomodel?.data?.dataInfo?[index].id ??
                                0);
                      },
                      onPressed2: () {
                        cubit.addtocart(
                      ...
                      text1: "${cubit.favomodel?.data?.dataInfo?[index].name}",
                      text2:
                          "${cubit.favomodel?.data?.dataInfo?[index].category}",
                      text3: "${cubit.favomodel?.data?.dataInfo?[index].price}",
                      image: "${cubit.favomodel?.data?.dataInfo?[index].image}",
                      text4:
                ...
                itemCount: cubit.favomodel?.data?.dataInfo?.length ?? 5,
              ),
            ),
          ),
        );
